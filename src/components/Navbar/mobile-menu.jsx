...
export const MobileMenu = ({ isNavOpen, toggleNav, menuItems }) => {
    return (
        <div className={isNavOpen ? 'z-50 flex flex-col fixed md:hidden left-0 top-0 w-full h-full bg-slate-100 text-slate-600 ease-in-out duration-500' : 'ease-in-out duration-500 fixed top-0 bottom-0 left-[-100%]'}>
